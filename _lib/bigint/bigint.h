...
#if BIGINT_BERN_NUM > 0		// number of table Bernoulli numbers - use number 0, 256, 512, 768 or 1024
...
#endif // BIGINT_BERN_NUM > 0		// number of table Bernoulli numbers - use number 0, 256, 512, 768 or 1024
