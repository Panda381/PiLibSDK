...
#define MAXUNIXDT 4102444799ul	// max. value of Unix date and time value (=0xF48656FF)
				//    0 = 00:00:00 1/1/1970
...
#define FILETIMEOFF (s64)504912960000000000ll // Windows file time base offset
#define FILETIMEDAY 584390	// absolute day of Windows file time base (=day of Monday 1/1/1601 CE 0:00:00)

#define UNIXBASEOFF (s64)621357696000000000ll // Unix base offset
...
INLINE Bool DateTime64IsLeap(const sDateTime64* dt) { return (dt->flags & DTFLAG_LEAP) != 0; } 

// get flag - date of Gregorian calendar (or Julian otherwise) DTFLAG_GREG
INLINE Bool DateTime64IsGreg(const sDateTime64* dt) { return (dt->flags & DTFLAG_GREG) != 0; }

// get flag - year has 53 weeks DTFLAG_W53
INLINE Bool DateTime64IsW53(const sDateTime64* dt) { return (dt->flags & DTFLAG_W53) != 0; }

// get flag - last week of previous year DTFLAG_LASTW
INLINE Bool DateTime64IsLastW(const sDateTime64* dt) { return (dt->flags & DTFLAG_LASTW) != 0; }

// get flag - first week of next year DTFLAG_FIRSTW
INLINE Bool DateTime64IsFirstW(const sDateTime64* dt) { return (dt->flags & DTFLAG_FIRSTW) != 0; }
