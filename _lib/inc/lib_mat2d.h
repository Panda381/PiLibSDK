...
#define MAT2D_FRACT		12	// number of bits of fractional part of fractint number (use max. 13, min. 8)
#define MAT2D_FRACTMUL (1<<MAT2D_FRACT)
#define MAT2D_TOFRACT(f) float2int((f)*MAT2D_FRACTMUL)
...
// set zero matrix
INLINE void Mat2D_Zero(sMat2D* m)
{
