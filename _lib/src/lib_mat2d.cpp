...
{
	mat[0] = MAT2D_TOFRACT(m->m11);
	mat[1] = MAT2D_TOFRACT(m->m12);
	mat[2] = MAT2D_TOFRACT(m->m13);
	mat[3] = MAT2D_TOFRACT(m->m21);
	mat[4] = MAT2D_TOFRACT(m->m22);
	mat[5] = MAT2D_TOFRACT(m->m23);
}
