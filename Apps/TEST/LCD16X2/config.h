...
// Font
#define FONT		FontLcd5x7	// default fixed font
#define FONTW		6		// width of fixed font
...
#define SCREENSCALE	2		// 0 = no back buffer, using back buffer with screen scale 1, 2 or 4
