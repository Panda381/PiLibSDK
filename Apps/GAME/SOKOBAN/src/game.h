...
#define AUTOMODE	0	// 1=automode, autorun all levels to check solutions, 0=normal

// game speed
#if AUTOMODE	// automode - autorun all levels to check solutions
#define MOVESPEED	1	// step delay in [ms]
#else
#define MOVESPEED	50	// step delay in [ms]
#endif

// Define game board, tiles 4x4
