...
// Screen
#define DISPZOOM	2		// display zoom: 1=use 320x240, 2=use 640x480
...
#define DRAWTEXT	DrawText	// draw text function
#define DRAWTEXTBG	DrawTextBg	// draw text function
#else
...
#define DRAWTEXT	DrawText2	// draw text function
#define DRAWTEXTBG	DrawTextBg2	// draw text function
#endif
