...
#include "../img/tiles.cpp"	// const u8 TilesImg[] 16x272 (1x17 tiles, 1 tile 16x16)
...
#define SPEED	20	// step speed (delay in [ms])
...
void DrawBoard()
{
	...
	for (i = 0; i < MAPH; i++)
	{
		for (j = 0; j < MAPW; j++)
		{
			...
			DrawImg(TilesImg, x, y, 0, b*TILESIZE, TILESIZE, TILESIZE);
		}
	}
	DispUpdate();
}
