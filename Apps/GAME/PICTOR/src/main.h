...
#define DEB_SOUND	2		// initial sound mode 0=off, 1=sound, 2=all
#define DEB_ALLACTORS	0		// 1=all actors are available, 0=normal mode
#define DEB_SMALLHIT	0		// 1=small hit actor
#define DEB_AUTOSHOOT	0		// 1=autoshoot
#endif
...
// main setup
#define LEVEL_NUM	12		// number of levels
#define BG_NUM		LEVEL_NUM	// number of backgrounds
#define ACT_NUM		(LEVEL_NUM+1)	// number of actors, including Jill (= 13)
...
// common resources
extern u8 *BloodImg, *BonuscloudImg, *ExplosionImg, *TitleImg, *PicopadImg;
