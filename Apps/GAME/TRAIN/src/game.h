...
// >>>>> DEBUG SETUP <<<<<
#define AUTOMODE	0	// 1=automode - run levels to check solutions (help completes scene), 0=normal
...
#define MAPY	32		// board Y coordinate

// Info box
#define BOXW	(16*8*2)	// width of info box
#define BOXH	(5*16*2)	// height of info box
#define BOXX	((WIDTH-BOXW)/2) // coordinate X of info box
#define BOXY	((HEIGHT-8*2-BOXH)/2) // coordinate Y of info box
