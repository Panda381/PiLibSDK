...
Bool Open()
{
	...
	while (True)
	{
		...
		// display title
		DrawImg(TitleImg, (WIDTH - TITLE_IMG_W)/2, 10,
			0, 0, TITLE_IMG_W, TITLE_IMG_H);
		...
		DrawText("Version for Raspberry Zero", (WIDTH - 26*8)/2, HEIGHT-16, COL_YELLOW);
		DrawText("(c) 2026 Miroslav Nemecek", (WIDTH - 25*8)/2, HEIGHT-8, COL_YELLOW);
