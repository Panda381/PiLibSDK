...
void DispObj()
{
	...
	for (i = OBJ_MAX; i > 0; i--)
	{
		...
		if (o->type != ENEMY_NO)
		{
			...
			// small disk
			case ENEMY_DISK:
				DrawImg(UfoImg, (o->x >> FRAC) - UFO_IMG_W/2, y - UFO_IMG_H,
					0, n*UFO_IMG_H, UFO_IMG_W, UFO_IMG_H);
				break;

			// big enemy			
			case ENEMY_BIG:
				DrawImg(Ufo2Img, (o->x >> FRAC) - UFO2_IMG_W/2, y - UFO2_IMG_H,
					n*UFO2_IMG_W, 0, UFO2_IMG_W, UFO2_IMG_H);
				break;

			// boss
			case ENEMY_BOSS:
				DrawImg(BossImg, (o->x >> FRAC) - BOSS_IMG_W/2, y - BOSS_IMG_H,
					0, n*BOSS_IMG_H, BOSS_IMG_W, BOSS_IMG_H);
				break;

			// crash
			case ENEMY_CRASH:
				DrawImg(ExplosionImg, (o->x >> FRAC) - EXPLOSION_IMG_W/2, y - EXPLOSION_IMG_H,
					0, o->istep*EXPLOSION_IMG_H, EXPLOSION_IMG_W, EXPLOSION_IMG_H);
				break;

			// bomb
			case ENEMY_BOMB:
				DrawImg(BombImg, (o->x >> FRAC) - BOMB_IMG_W/2, y - BOMB_IMG_H - 15,
					0, n*BOMB_IMG_H, BOMB_IMG_W, BOMB_IMG_H);
				break;
			}
		}
