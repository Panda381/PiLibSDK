...
ONE:
	...
	while(1)
	{
		if (VARIABLE.Frame%8==0)
		{
			...
			if ((VARIABLE.launch==0)&&(KeyPressed(KEY_PAD_A)/*digitalRead(1)==LOW*/)) VARIABLE.launch=1;
...
const u32 MainCol[8] = { COL_WHITE, COL_WHITE, COL_YELLOW, COL_YELLOW,
...
u32 BlockCol[6] = { COL_GREEN, COL_BLUE, COL_YELLOW, COL_RED, COL_CYAN, COL_MAGENTA };
