...
// Font
#define FONT		FontBold8x8	// default fixed font
#define FONTW		8		// width of fixed font
#define FONTH		8		// height of fixed font
#define FONTPROP	FontLGB18	// default proportional font
...
// Screen
#define WIDTH		160		// draw width (0=do not initialize default videomode)
#define HEIGHT		120		// draw height
#define SCREENSCALE	4		// 0 = no back buffer, or use back buffer with screen scale 1, 2 or 4
