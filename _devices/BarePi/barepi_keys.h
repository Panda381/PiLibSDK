...
#ifndef _BAREPI_KEYS_H
#define _BAREPI_KEYS_H
...
#define KEY_A_GPIO	22
#define KEY_B_GPIO	23
#define KEY_X_GPIO	24
#define KEY_Y_GPIO	27
#define KEY_RIGHT_GPIO	25
#define KEY_UP_GPIO	6
#define KEY_LEFT_GPIO	26
#define KEY_DOWN_GPIO	5
#define KEY_ALT_GPIO	4
...
#define KEY_NUM		9	// number of keys
...
#define KEY_MENU	(KEY_Y | KEYFLAG_ALT)
#define KEY_SCREENSHOT	(KEY_X | KEYFLAG_ALT)
#define KEY_INSERT	(KEY_A | KEYFLAG_ALT)
#define KEY_EDIT	(KEY_B | KEYFLAG_ALT)
